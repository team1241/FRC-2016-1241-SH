//github.com/shaqeebmomen/FRC-2016-1241-SH.gitpackage com.team1241.frc2016.subsystems;
...
public class Shooter extends Subsystem {
	...
	public Shooter(){
		//Initialize Talons
		 rightShooter = new CANTalon (ElectricalConstants.RIGHT_SHOOTER);
		 leftShooter = new CANTalon (ElectricalConstants.LEFT_SHOOTER);
		 
	     //Initialize Pistons		
		 popUp = new DoubleSolenoid (ElectricalConstants.POP_UP_SOLENOID,ElectricalConstants.POP_DOWN_SOLENOID);
		 hoodPop = new DoubleSolenoid (ElectricalConstants.HOOD_SOLENOID_A,ElectricalConstants.HOOD_SOLENOID_B);
		 
		//Initialize PID	
		 velPID = new PIDController (NumberConstants.pShoot,
								   NumberConstants.iShoot,
								   NumberConstants.dShoot);
	}
